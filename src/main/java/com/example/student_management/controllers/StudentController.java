...
public class StudentController {
    ...
    @Operation(summary = "Ajouter un nouvel étudiant",
            description = "Crée et enregistre un étudiant dans la base de données.")
    ...
    @Operation(summary = "Supprimer un étudiant par ID",
            description = "Supprime un étudiant existant via son identifiant.")
    ...
    @Operation(summary = "Afficher les étudiants par année",
            description = "Regroupe les étudiants selon leur année d’inscription.")
    @GetMapping("/byYear")
